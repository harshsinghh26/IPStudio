    ...
    <div className="container bg-[#0000007A] max-w-screen flex flex-col items-center justify-center">
      <div className="card max-w-[1000px]">
        <div className="cardetails bg-ip-grey w-[800px] h-[600px] flex flex-col items-center pt-20 pb-5 px-10">
          ...
          <p className="text-[#86868B] text-lg py-3">
          ...
          <p className="text-ip-font text-[11px] text-center w-[480px] mt-1">
            Your IPStudio Account information is used to allow you to sign in
            securely and access your data. IPStudio records certain data for
            security, support and reporting purposes. If you agree, IPStudio may
            also use your IPStudio Account information to send you marketing
            emails and communications, including based on your use of IPStudio
            services.{" "}
          </p>
          <a className="text-[11px] text-ip-red underline font-medium">
            See how your data is managed...
          </a>
          <button className="bg-ip-gradient2 px-24 py-2 rounded-lg text-lg my-5">
            <span className="text-ip-font">Continue</span>
          </button>
        </div>
      </div>
    </div>
