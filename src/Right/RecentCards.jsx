...
const cards = [
  {
    id: 1,
    img: card1,
    song: { id: 1, title: "Summer High", src: admire },
    details: "Karan Aujla & Similar Artists",
  },
  {
    id: 2,
    img: card2,
    song: { id: 2, title: "O Sajni Re", src: osajni },
    details:
      "Laapataa Ladies (Original Motion Picture Soundtrack) \n Ram Sampath, Divyanidhi Sharma,...",
  },
  {
    id: 3,
    img: card3,
    song: { id: 3, title: "Krishna Teri Ho Gyi", src: krishna },
    details: "Krishna Teri Ho Gyi - Single \n Asees Kaur, \n Jaani",
  },
  {
    id: 4,
    img: card4,
    song: { id: 4, title: "Achyutam Keshavam", src: achyutam },
    details:
  ...
  },
  {
    id: 5,
    img: card5,
    song: { id: 5, title: "O Maahi", src: omaahi },
    details:
      "Dunki (Original Motion Picture Soundtrack) \n Pritam, Swanand Kirkire, IP Singh,...",
  },
];
          ...
          <div className="flex flex-col items-start py-2 h-16 rounded-b-xl">
            {card.details.split("\n").map((line, index) => (
              <p
                ...
                className={`text-xs ${
                  index === 0
                    ? "text-ip-font font-semibold"
                    : "text-ip-font2 font-semibold"
                }`}
              >
                {line}
              </p>
