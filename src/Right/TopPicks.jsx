...
const cards = [
  {
    ...
    title: "New Release",
    img: card1,
    song: { id: 1, title: "Song 1", src: ruaan },
    details: "Ruaan - Club Version - Single \n Pritam \n 2 August",
    bgClass: "bg-ip-cardbg",
  },
  {
    id: 2,
    title: "Listen Again",
    img: card2,
    song: { id: 2, title: "Song 2", src: tainu },
    details:
      "Bollywood Hits \n A genre-spanning surge of effusive pop, \n cosy ballads and more.",
    bgClass: "bg-ip-cardbg1",
  },
  {
    id: 3,
    title: "Made for You",
    img: card3,
    song: { id: 3, title: "Song 3", src: magic },
    details: "Harsh's Stations",
    bgClass: "bg-ip-cardbg2",
  },
  {
    id: 4,
    title: "New Release",
    img: card4,
    song: { id: 4, title: "Song 4", src: bloody },
    details: "BLOODY BRAZIL (Hardstyle) - Single \n TENZOO, askat \n 26 July",
    bgClass: "bg-ip-cardbg3",
  },
];
      ...
      <div className="cards flex gap-4 mainbar">
        {cards.map((card) => (
          <div key={card.id} className="card w-72 hov">
            <h2 className="text-sm text-ip-font1 font-semibold pb-4">
              {card.title}
            </h2>
            ...
            <div
              className={`flex flex-col items-center py-2 h-16 rounded-b-xl ${card.bgClass}`}
            >
              {card.details.split("\n").map((line, index) => (
                <p key={index} className="text-xs text-ip-font font-semibold">
                  {line}
                </p>
              ))}
            </div>
